...
function isNoiseFrame(filename, documentUrl) {
  return filename === void 0 || filename === "" || filename === "<anonymous>" || EXTENSION_PROTOCOL.test(filename) || documentUrl !== void 0 && filename.replace(URL_SEARCH_OR_HASH, "") === documentUrl;
}
